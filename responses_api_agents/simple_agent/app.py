        ...
        while True:
            ...
            for output_function_call in all_fn_calls:
                try:
                    ...
                    # Model generated malformed tool call arguments — feed the
                    # error back as a tool response so the conversation can
                    # continue (or terminate with a low reward) instead of
                    # crashing the entire rollout batch.
